...
namespace AgentServer.Packet
{
    public class CommunityHandle
    {
        ...
        {
            Account User = Client.CurrentAccount;
            Client.SendAsync(new GameRoom_Hex(User, "742700000000", last));
        ...
        {
            Account User = Client.CurrentAccount;
            Client.SendAsync(new GameRoom_Hex(User, "5A47FFFFFFFF00000000CB781167B68B0600FFFFFFFFFFFFFFFF", last));
