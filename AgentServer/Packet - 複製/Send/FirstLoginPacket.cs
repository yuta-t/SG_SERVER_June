...
namespace AgentServer.Packet.Send
{
    ...
    {
        public FirstLoginSetNewNickNameOK_0X4C(Account User, byte last) : base(1, User.EncryptKey)
        {
    ...
    {
        public FirstLoginSetNewNickNameFail_0X4C(Account User, byte last) : base(1, User.EncryptKey)
        {
            ns.Write((byte)76); //0x4C  op code
            ns.Write(0x38); //0x38
            ns.Write(last); //end
    ...
    {
        public FirstLoginMakeStartCharacter_67_0X64(Account User, int charid, byte last) : base(1, User.EncryptKey)
        {
    ...
    {
        public FirstLoginMakeStartCharacterOK_0X71(Account User, byte last) : base(1, User.EncryptKey)
        {
