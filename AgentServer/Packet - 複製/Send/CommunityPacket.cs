...
namespace AgentServer.Packet.Send
{
    ...
    {
        public AddFriendSuccess(Account User, string nickname,short groupnum, byte last) : base(1, User.EncryptKey)
        {
    ...
    {
        public AddFriendFail(Account User, string nickname, byte last) : base(1, User.EncryptKey)
        {
            ns.Write((byte)0x74); //op
    ...
    {
        public CancelAddFriendOK(Account User, string nickname, byte last) : base(1, User.EncryptKey)
        {
            ns.Write((byte)0x74); //op
    ...
    {
        public DeclineAddFriendOK(Account User, string nickname, byte last) : base(1, User.EncryptKey)
        {
            ns.Write((byte)0x74); //op
    ...
    {
        public AcceptFriendOK(Account User, string nickname, byte last) : base(1, User.EncryptKey)
        {
            ns.Write((byte)0x74); //op
    ...
    {
        public GetAcceptedFriendList_7406(Account User, byte last) : base(1, User.EncryptKey)
        {
            ns.Write((byte)0x74); //op
    ...
    {
        public GetWaitAcceptFriendList_7407(Account User, byte last) : base(1, User.EncryptKey)
        {
            ns.Write((byte)0x74); //op
    ...
    {
        public GetRequestedToMe_741E(Account User, byte last) : base(1, User.EncryptKey)
        {
            using (var con = new MySqlConnection(Conf.Connstr))
            {
                con.Open();
    ...
    {
        public GetFriendGroupList_7420(Account User, byte last) : base(1, User.EncryptKey)
        {
            ns.Write((byte)0x74); //op
    ...
    {
        public AddFriendGroup_742001(Account User, string groupname, byte last) : base(1, User.EncryptKey)
        {
            ns.Write((byte)0x74); //op
            ns.Write((byte)0x20); //subop
            ns.Write((byte)1);
    ...
    {
        public ModifytFriendGroup_742002(Account User, short groupnum, string groupname, byte isfolding, byte last) : base(1, User.EncryptKey)
        {
            ns.Write((byte)0x74); //op
            ns.Write((byte)0x20); //subop
            ns.Write((byte)2);
    ...
    {
        public DelFriendGroup_742003(Account User, short groupnum, byte last) : base(1, User.EncryptKey)
        {
            ns.Write((byte)0x74); //op
            ns.Write((byte)0x20); //subop
            ns.Write((byte)3);
    ...
    {
        public GroupMoveMember(Account User, short groupnum, string nickname, byte last) : base(1, User.EncryptKey)
        {
            using (var con = new MySqlConnection(Conf.Connstr))
            {
                con.Open();
    ...
    {
        public BlockFriendOK(Account User,  string nickname, byte last) : base(1, User.EncryptKey)
        {
            ns.Write((byte)0x74); //op
    ...
    {
        public UnBlockFriendOK(Account User, string nickname, byte last) : base(1, User.EncryptKey)
        {
            ns.Write((byte)0x74); //op
    ...
    {
        public DeleteFriendOK(Account User, string nickname, byte last) : base(1, User.EncryptKey)
        {
            ns.Write((byte)0x74); //op
    ...
    {
        public GetUserAlarmInfo(Account User, byte last) : base(1, User.EncryptKey)
        {
            ns.Write((byte)0xFF); 
