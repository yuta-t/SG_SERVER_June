...
namespace AgentServer.Packet.Send
{
    ...
    {
        public ShopBuyItem_ACK(Account User, int itemid, int unk3, int unk4, int unk5, byte last) : base(1, User.EncryptKey)
        {
    ...
    {
        public ShopBuyItemFail(Account User, int itemid, int unk3, int unk4, int unk5, byte last) : base(1, User.EncryptKey)
        {
    ...
    {
        public ShopBuyFreePassUpdate(Account User, byte last) : base(1, User.EncryptKey)
        {
    ...
    {
        public ShopBuyFreePassUpdate2(Account User, byte last) : base(1, User.EncryptKey)
        {
    ...
    {
        public ShopGiftItemOK_ACK(Account User, int itemid, string nickname, byte last) : base(1, User.EncryptKey)
        {
    ...
    {
        public ShopGiftItemError_ACK(Account User, byte errorid, byte last) : base(1, User.EncryptKey)
        {
    ...
    {
        public ShopBuyItemInfo_ACK(Account User, List<AvatarItemInfo> iteminfos, byte last) : base(1, User.EncryptKey)
        {
    ...
    {
        public CurrentGameMoney_ACK(Account User, byte last) : base(1, User.EncryptKey)
        {
            /*using (var con = new MySqlConnection(Conf.Connstr))
            {
                con.Open();
