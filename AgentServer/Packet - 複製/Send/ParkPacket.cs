...
namespace AgentServer.Packet.Send
{
    ...
    {
        public GetMachineInfo(Account User, int MachineNum, CapsuleMachineInfo MachineInfo,  byte last) : base(1, User.EncryptKey)
        {
    ...
    {
        public GetMachineInfoFail(Account User, int MachineItemNum, int MachineID, byte last) : base(1, User.EncryptKey)
        {
    ...
    {
        public GetMachineInfoResetting(Account User, int MachineNum, CapsuleMachineInfo MachineInfo, byte last) : base(1, User.EncryptKey)
        {
    ...
    {
        public GetMachineSelectItem(Account User, int MachineItemNum, int ResultItemNum, byte last) : base(1, User.EncryptKey)
        {
    ...
    {
        public MachineGiveItem(Account User, int ResultItemNum, bool isGift, string NickName, byte last) : base(1, User.EncryptKey)
        {
            /*FF 32 02 66 F1 00 00 84 E7 00 00 01*/
    ...
    {
        public MachineKeepItem(Account User, long uniqueNum, int itemNum, long dateTime, byte last) : base(1, User.EncryptKey)
        {
    ...
    {
        public CapsuleMachineNotice(Account User, byte level, int MachineItemNum, int ItemNum, string NickName) : base(1, User.EncryptKey)
        {
    ...
    {
        public RoatateMachineNotice(Account User, string MachineItemNum) : base(1, User.EncryptKey)
        {
    ...
    {
        public AlchemistMix(Account User, int resultitem, List<ItemAttr> Attrs, byte last) : base(1, User.EncryptKey)
        {
    ...
    {
        public AlchemistUpgrade(Account User, int resultitem, List<ItemAttr> Attrs, byte last) : base(1, User.EncryptKey)
        {
